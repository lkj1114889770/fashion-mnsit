...
def imagenet_resnet_v2_generator(block_fn, layers, num_classes):
  ...
  def model(inputs, is_training):
    ...
    inputs = conv2d_fixed_padding(
        inputs=inputs, filters=64, kernel_size=5, strides=1)
    ...
    inputs = tf.reshape(inputs,[-1,49*128])
...
def imagenet_resnet_v2(resnet_size, num_classes):
  ...
  model_params = {
      13: {'block': building_block, 'layers': [2, 2]},
...
def resnet_v2(feature, mode):
    net = imagenet_resnet_v2(13, 10)
